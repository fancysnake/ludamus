...
def _design_mock_event_info() -> EventInfo:
...
class DesignPageView(TemplateView):
    ...
    def get_context_data(self, **kwargs: Any) -> dict[str, Any]:
        context = super().get_context_data(**kwargs)
        context["design_event"] = _design_mock_event_info()
        context["design_session_data"] = _design_mock_session_data()
        context["design_session_data_ended"] = _design_mock_session_data_ended()
        return context
