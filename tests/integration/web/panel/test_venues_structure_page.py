...
class TestVenuesStructurePageView:
    ...
    def test_returns_multiple_venues_with_nested_structure(
        ...
        area1 = Area.objects.create(
            event=event, venue=venue1, name="Floor 1", slug="floor-1", order=0
        )
        Space.objects.create(
            event=event, area=area1, name="Room 1A", slug="room-1a", order=0
        )
        Space.objects.create(
            event=event, area=area1, name="Room 1B", slug="room-1b", order=1
        )
        area2 = Area.objects.create(
            event=event, venue=venue1, name="Floor 2", slug="floor-2", order=1
        )
        Space.objects.create(
            event=event, area=area2, name="Room 2A", slug="room-2a", order=0
        )
        ...
        area3 = Area.objects.create(
            event=event, venue=venue2, name="Main Hall", slug="main-hall", order=0
        )
        Space.objects.create(
            event=event, area=area3, name="Stage", slug="stage", order=0
        )
    ...
    def test_areas_ordered_by_order_field(
        ...
        area_z = Area.objects.create(
            event=event, venue=venue, name="Zone Z", slug="zone-z", order=2
        )
        area_a = Area.objects.create(
            event=event, venue=venue, name="Zone A", slug="zone-a", order=1
        )
    ...
    def test_spaces_ordered_by_order_field(
        ...
        area = Area.objects.create(
            event=event, venue=venue, name="Area", slug="area", order=0
        )
        space_z = Space.objects.create(
            event=event, area=area, name="Room Z", slug="room-z", order=2
        )
        space_a = Space.objects.create(
            event=event, area=area, name="Room A", slug="room-a", order=1
        )
