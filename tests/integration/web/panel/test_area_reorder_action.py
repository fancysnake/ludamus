...
class TestAreaReorderActionView:
    ...
    def test_post_reorders_areas_for_sphere_manager(
        ...
        area1 = Area.objects.create(
            event=event, venue=venue, name="Area 1", slug="area-1", order=0
        )
        area2 = Area.objects.create(
            event=event, venue=venue, name="Area 2", slug="area-2", order=1
        )
        area3 = Area.objects.create(
            event=event, venue=venue, name="Area 3", slug="area-3", order=2
        )
    ...
    def test_post_ignores_areas_from_other_venues(
        ...
        area1 = Area.objects.create(
            event=event, venue=venue1, name="Area 1", slug="area-1", order=0
        )
        area2 = Area.objects.create(
            event=event, venue=venue2, name="Area 2", slug="area-2", order=0
        )
