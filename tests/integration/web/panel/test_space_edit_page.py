...
class TestSpaceEditPageView:
    ...
    def test_get_redirects_anonymous_user_to_login(self, client, event):
        ...
        area = Area.objects.create(
            event=event, venue=venue, name="Test Area", slug="test-area"
        )
        space = Space.objects.create(
            event=event, area=area, name="Test Space", slug="test-space"
        )
    ...
    def test_get_ok_for_sphere_manager(
        ...
        area = Area.objects.create(
            event=event, venue=venue, name="East Wing", slug="east-wing"
        )
        space = Space.objects.create(
    ...
    def test_post_updates_space_for_sphere_manager(
        ...
        space = Space.objects.create(
            event=event, area=area, name="Room 101", slug="room-101"
        )
    ...
    def test_post_updates_space_capacity(
        ...
        space = Space.objects.create(
            event=event, area=area, name="Room 101", slug="room-101", capacity=None
        )
    ...
    def test_post_generates_unique_slug_on_name_change(
        ...
        space2 = Space.objects.create(
            event=event, area=area, name="Room 102", slug="room-102"
        )
